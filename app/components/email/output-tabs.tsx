export type OutputTab = 'enhanced' | 'psychology' | 'improvements' | 'alternatives' | 'deliverability' | 'strategy' | 'insights';
...
export function OutputTabs({ value, onChange }: OutputTabsProps): JSX.Element {
  const tabs: Array<{ id: OutputTab; label: string }> = [
    { id: 'enhanced', label: 'Enhanced Email' },
    { id: 'psychology', label: 'Psychology' },
    { id: 'improvements', label: 'Improvements' },
    { id: 'alternatives', label: 'A/B Tests' },
    { id: 'deliverability', label: 'Deliverability' },
    { id: 'strategy', label: 'Follow-up' },
    { id: 'insights', label: 'Industry' },
  ];
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-800">
      <nav className="flex space-x-8 overflow-x-auto px-6" aria-label="Output tabs">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            type="button"
